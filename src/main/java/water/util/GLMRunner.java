...
public class GLMRunner {
  ...
  public static void main(String[] args) throws InterruptedException {
    try {
      ...
      GLMJob j = DGLM.startGLMJob(DGLM.getData(ary, xcols,ycol, null, true), new ADMMSolver(ARGS.lambda,ARGS._alpha), GLMParams.GLMParamsFromName(DGLM.Families.valueOf(ARGS.family)), null, ARGS.xval, true);
